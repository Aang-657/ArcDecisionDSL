...
class ArchDecisionParser ( Parser ):
    ...
    class RequirementsBlockContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitRequirementsBlock" ):
                return visitor.visitRequirementsBlock(self)
            else:
                return visitor.visitChildren(self)
    ...
    class RequirementItemContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitRequirementItem" ):
                return visitor.visitRequirementItem(self)
            else:
                return visitor.visitChildren(self)
    ...
    class ConstraintItemContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitConstraintItem" ):
                return visitor.visitConstraintItem(self)
            else:
                return visitor.visitChildren(self)
